...
class Iconic_Blog_Adminhtml_Blog_ParentcategoryController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction() {
        $this->_initAction(); 
        $this->_addContent($this->getLayout()->createBlock('blog/adminhtml_parentcategory'));
        $this->renderLayout();
    }
    ...
    public function editAction()
    {
        ...
        $blogModel  = Mage::getModel('blog/parentcategory')->load($blogId);
        if ($blogModel->getId() || $blogId == 0) {
            ...
            $this->_addContent($this->getLayout()->createBlock('blog/adminhtml_parentcategory_edit'))
                 ->_addLeft($this->getLayout()->createBlock('blog/adminhtml_parentcategory_edit_tabs'));
    ...
    public function saveAction()
    {
        if ( $this->getRequest()->getPost() ) {
            try {
                ...
                $blogModel = Mage::getModel('blog/parentcategory');
    ...
    public function gridAction()
    {
        ...
        $this->getResponse()->setBody(
               $this->getLayout()->createBlock('blog/adminhtml_parentcategory_grid')->toHtml()
        );
    }
}